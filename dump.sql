...
DROP TABLE APPROVED_EVENTS;
DROP TABLE PRE_APPROVED_EVENTS;
DROP SEQUENCE SEQ_ACCOUNTS;
DROP SEQUENCE SEQ_WALLETS;
...
CREATE TABLE PRE_APPROVED_EVENTS (
    id_pap NUMBER PRIMARY KEY,
    data_inicio VARCHAR2(10),
    data_fim VARCHAR2(10),
    valor_cota NUMBER,
    descricao VARCHAR2(1000),
...
INCREMENT BY 1;
CREATE SEQUENCE SEQ_WALLETS START WITH 1
INCREMENT BY 1;
COMMIT;